...
Download the Single Checkbox Parameter [manifest file](https://tagyoureit.github.io/tableau-single-checkbox-parameters/single-checkbox-parameter.trex). Open Tableau Desktop 2018.2 or higher, drag in the "Extension" object to a dashboard. Click "My Extensions" and find the manifest file (.trex) you downloaded above.
...
3. Select the <a href='https://tagyoureit.github.io/tableau-single-checkbox-parameters/single-checkbox-parameter.trex'>manifest file</a> you downloaded.
