					...
					<div className='box'>
						...
						<div className='right'>
							...
							<ol>
								...
								<li>Download/find the manifest <a href='https://tagyoureit.github.io/tableau-single-checkbox-parameters/single-checkbox-parameter.trex'>manifest file</a> you downloaded.</li>
